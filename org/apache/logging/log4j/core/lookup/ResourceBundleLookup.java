...
public class ResourceBundleLookup extends AbstractLookup
{
    ...
    public String lookup(final LogEvent event, final String key) {
        ...
        if (keyLen != 2) {
            ResourceBundleLookup.LOGGER.warn(ResourceBundleLookup.LOOKUP, "Bad ResourceBundle key format [{}]. Expected format is BundleName:KeyName.", new Object[] { key });
            return null;
        }
        ...
        try {
            ...
            ResourceBundleLookup.LOGGER.warn(ResourceBundleLookup.LOOKUP, "Error looking up ResourceBundle [{}].", new Object[] { bundleName, e });
            return null;
        }
    }
