...
public final class ExtendedThrowablePatternConverter extends ThrowablePatternConverter
{
    ...
    public void format(final LogEvent event, final StringBuilder toAppendTo) {
        ...
        if ((throwable != null || proxy != null) && this.options.anyLines()) {
            ...
            final String extStackTrace = proxy.getExtendedStackTraceAsString(this.options.getPackages());
            final int len = toAppendTo.length();
            if (len > 0 && !Character.isWhitespace(toAppendTo.charAt(len - 1))) {
                toAppendTo.append(' ');
            }
            if (!this.options.allLines() || !Constants.LINE_SEPARATOR.equals(this.options.getSeparator())) {
