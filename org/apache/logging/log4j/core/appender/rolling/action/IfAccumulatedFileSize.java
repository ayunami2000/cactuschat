...
public final class IfAccumulatedFileSize implements PathCondition
{
    ...
    public boolean accept(final Path basePath, final Path relativePath, final BasicFileAttributes attrs) {
        ...
        IfAccumulatedFileSize.LOGGER.trace("IfAccumulatedFileSize {}: {} accumulated size '{}' {} thresholdBytes '{}'", new Object[] { accept, relativePath, this.accumulatedSize, match, this.thresholdBytes });
        if (result) {
