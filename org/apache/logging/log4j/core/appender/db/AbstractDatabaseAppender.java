...
public abstract class AbstractDatabaseAppender<T extends AbstractDatabaseManager> extends AbstractAppender
{
    ...
    public final void append(final LogEvent event) {
        ...
        try {
            ...
            AbstractDatabaseAppender.LOGGER.error("Unable to write to database [{}] for appender [{}].", new Object[] { this.getManager().getName(), this.getName(), e });
            throw e;
        }
        catch (Exception e2) {
            AbstractDatabaseAppender.LOGGER.error("Unable to write to database [{}] for appender [{}].", new Object[] { this.getManager().getName(), this.getName(), e2 });
