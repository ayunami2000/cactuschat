...
public class JsonConfiguration extends AbstractConfiguration implements Reconfigurable
{
    ...
    public JsonConfiguration(final ConfigurationSource configSource) {
        ...
        try {
            ...
            JsonConfiguration.LOGGER.error("Error parsing {}", new Object[] { configSource.getLocation(), ex });
        }
    }
    ...
    public void setup() {
        ...
        while (iter.hasNext()) {
            ...
            if (n.isObject()) {
                JsonConfiguration.LOGGER.debug("Processing node for object {}", new Object[] { entry.getKey() });
    ...
    public Configuration reconfigure() {
        try {
            ...
            JsonConfiguration.LOGGER.error("Cannot locate file {}", new Object[] { this.getConfigurationSource(), ex });
            return null;
        }
    }
    ...
    private Node constructNode(final String name, final Node parent, final JsonNode jsonNode) {
        ...
        while (iter.hasNext()) {
            ...
            if (n.isArray() || n.isObject()) {
                ...
                if (n.isArray()) {
                    JsonConfiguration.LOGGER.debug("Processing node for array {}", new Object[] { entry.getKey() });
                    for (int i = 0; i < n.size(); ++i) {
                        ...
                        if (pluginType.equals(entry.getKey())) {
                            JsonConfiguration.LOGGER.debug("Processing {}[{}]", new Object[] { entry.getKey(), i });
                        }
                        else {
                            JsonConfiguration.LOGGER.debug("Processing {} {}[{}]", new Object[] { pluginType, entry.getKey(), i });
                        }
                        ...
                        while (itemIter.hasNext()) {
                            ...
                            if (itemEntry.getValue().isObject()) {
                                JsonConfiguration.LOGGER.debug("Processing node for object {}", new Object[] { itemEntry.getKey() });
                                ...
                                JsonConfiguration.LOGGER.debug("Processing array for object {}", new Object[] { entryName });
                ...
                JsonConfiguration.LOGGER.debug("Node {} is of type {}", new Object[] { entry.getKey(), n.getNodeType() });
            }
        }
        String t;
        if (type == null) {
        ...
        JsonConfiguration.LOGGER.debug("Returning {} with parent {} of type {}", new Object[] { node.getName(), p, t });
        return node;
    }
