...
public class JndiManager extends AbstractManager
{
    ...
    public static JndiManager getJndiManager(final String initialContextFactoryName, final String providerURL, final String urlPkgPrefixes, final String securityPrincipal, final String securityCredentials, final Properties additionalProperties) {
        ...
        if (providerURL != null) {
            ...
            JndiManager.LOGGER.warn("The JNDI InitialContextFactory class name [{}] was provided, but there was no associated provider URL. This is likely to cause problems.", new Object[] { initialContextFactoryName });
        }
        ...
        if (securityPrincipal != null) {
            ...
            if (securityCredentials != null) {
                ...
                JndiManager.LOGGER.warn("A security principal [{}] was provided, but with no corresponding security credentials.", new Object[] { securityPrincipal });
            }
        }
