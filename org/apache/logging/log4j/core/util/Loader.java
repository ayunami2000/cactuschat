...
public final class Loader
{
    ...
    public static URL getResource(final String resource, final ClassLoader defaultLoader) {
        try {
            ...
            if (classLoader != null) {
                Loader.LOGGER.trace("Trying to find [{}] using context class loader {}.", new Object[] { resource, classLoader });
            ...
            if (classLoader != null) {
                Loader.LOGGER.trace("Trying to find [{}] using {} class loader.", new Object[] { resource, classLoader });
                final URL url = classLoader.getResource(resource);
                if (url != null) {
                    return url;
                }
            ...
            if (defaultLoader != null) {
                Loader.LOGGER.trace("Trying to find [{}] using {} class loader.", new Object[] { resource, defaultLoader });
        ...
        Loader.LOGGER.trace("Trying to find [{}] using ClassLoader.getSystemResource().", new Object[] { resource });
    ...
    public static Class<?> loadSystemClass(final String className) throws ClassNotFoundException {
        try {
            ...
            Loader.LOGGER.trace("Couldn't use SystemClassLoader. Trying Class.forName({}).", new Object[] { className, t });
    ...
    public static boolean isClassAvailable(final String className) {
        try {
            ...
            Loader.LOGGER.trace("Unknown error checking for existence of class [{}].", new Object[] { className, e });
            return false;
        }
    }
