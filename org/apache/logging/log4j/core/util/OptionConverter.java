...
public final class OptionConverter
{
    ...
    public static Object instantiateByKey(final Properties props, final String key, final Class<?> superClass, final Object defaultValue) {
        ...
        if (className == null) {
            OptionConverter.LOGGER.error("Could not find value for key {}", new Object[] { key });
            return defaultValue;
        }
    ...
    public static int toInt(final String value, final int defaultValue) {
        if (value != null) {
            ...
            try {
                ...
                OptionConverter.LOGGER.error("[{}] is not in proper int form.", new Object[] { s, e });
            }
        }
        return defaultValue;
    }
    ...
    public static long toFileSize(final String value, final long defaultValue) {
        ...
        try {
            ...
            OptionConverter.LOGGER.error("[{}] is not in proper int form.", new Object[] { str });
            OptionConverter.LOGGER.error("[{}] not in expected format.", new Object[] { value, e });
            return defaultValue;
        }
    }
    ...
    public static String findAndSubst(final String key, final Properties props) {
        ...
        try {
            ...
            OptionConverter.LOGGER.error("Bad option value [{}].", new Object[] { value, e });
            return value;
        }
    }
        ...
        if (className != null) {
            try {
                ...
                if (!superClass.isAssignableFrom(classObj)) {
                    OptionConverter.LOGGER.error("A \"{}\" object is not assignable to a \"{}\" variable.", new Object[] { className, superClass.getName() });
                    OptionConverter.LOGGER.error("The class \"{}\" was loaded by [{}] whereas object of type [{}] was loaded by [{}].", new Object[] { superClass.getName(), superClass.getClassLoader(), classObj.getName() });
                    return defaultValue;
                }
                return classObj.newInstance();
            }
            catch (Exception e) {
                OptionConverter.LOGGER.error("Could not instantiate class [{}].", new Object[] { className, e });
            }
        }
        return defaultValue;
    }
