...
public final class StringEncoder
{
    ...
    public static byte[] encodeSingleByteChars(final String s) {
    ...
    public static int encodeIsoChars(final String charArray, int charIndex, final byte[] byteArray, int byteIndex, final int length) {
        int i;
        for (i = 0; i < length; ++i) {
    ...
    public static int encodeString(final String charArray, int charOffset, int charLength, final byte[] byteArray) {
        int byteOffset = 0;
