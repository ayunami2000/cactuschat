    ...
    public static File fileFromUri(URI uri) {
        ...
        if (uri.getScheme() == null) {
            ...
            try {
                ...
                FileUtils.LOGGER.warn("Invalid URI {}", new Object[] { uri });
                return null;
            }
        }
        ...
        try {
            ...
            FileUtils.LOGGER.warn("Invalid URL {}", new Object[] { uri, ex });
        }
        catch (UnsupportedEncodingException uee) {
            FileUtils.LOGGER.warn("Invalid encoding: {}", new Object[] { charsetName, uee });
        }
        return null;
    }
