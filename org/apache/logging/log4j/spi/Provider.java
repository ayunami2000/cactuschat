...
public class Provider
{
    ...
    public Class<? extends LoggerContextFactory> loadLoggerContextFactory() {
        ...
        try {
            ...
            Provider.LOGGER.error("Unable to create class {} specified in {}", new Object[] { this.className, this.url.toString(), e });
        }
        return null;
    }
    ...
    public Class<? extends ThreadContextMap> loadThreadContextMap() {
        ...
        try {
            ...
            Provider.LOGGER.error("Unable to create class {} specified in {}", new Object[] { this.threadContextMap, this.url.toString(), e });
        }
        return null;
    }
    ...
    public String toString() {
        ...
        if (this.priority != Provider.DEFAULT_PRIORITY) {
