...
public final class ReflectionUtil
{
    ...
    public static Class<?> getCallerClass(final int depth) {
        ...
        if (supportsFastReflection()) {
            try {
                ...
                ReflectionUtil.LOGGER.error("Error in ReflectionUtil.getCallerClass({}).", new Object[] { depth, e });
                return null;
            }
        }
        ...
        try {
            ...
            ReflectionUtil.LOGGER.error("Could not find class in ReflectionUtil.getCallerClass({}).", new Object[] { depth, e2 });
            return null;
        }
    }
    ...
    static StackTraceElement getEquivalentStackTraceElement(final int depth) {
        ...
        ReflectionUtil.LOGGER.error("Could not find an appropriate StackTraceElement at index {}", new Object[] { depth });
        throw new IndexOutOfBoundsException(Integer.toString(depth));
    }
    ...
    private static boolean isValid(final StackTraceElement element) {
        ...
        return (!cn.startsWith("java.lang.reflect.") || (!mn.equals("invoke") && !mn.equals("newInstance"))) && (!cn.equals("java.lang.Class") || !mn.equals("newInstance")) && (!cn.equals("java.lang.invoke.MethodHandle") || !mn.startsWith("invoke"));
    }
    ...
    static {
        ...
        try {
            ...
            if (o == null || o != sunReflectionClass) {
                ReflectionUtil.LOGGER.warn("Unexpected return value from Reflection.getCallerClass(): {}", new Object[] { test1 });
                getCallerClass = null;
