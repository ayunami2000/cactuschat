...
public class Activator implements BundleActivator, SynchronousBundleListener
{
    ...
    private void loadProvider(final Bundle bundle) {
        ...
        try {
            ...
            Activator.LOGGER.debug("Cannot access bundle [{}] contents. Ignoring.", new Object[] { bundle.getSymbolicName(), e });
        }
        catch (Exception e2) {
            Activator.LOGGER.warn("Problem checking bundle {} for Log4j 2 provider.", new Object[] { bundle.getSymbolicName(), e2 });
        }
    }
