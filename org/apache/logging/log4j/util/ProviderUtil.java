...
public final class ProviderUtil
{
    ...
    protected static void loadProvider(final URL url, final ClassLoader cl) {
        try {
            ...
            if (validVersion(props.getProperty("Log4jAPIVersion"))) {
                ...
                ProviderUtil.LOGGER.debug("Loaded Provider {}", new Object[] { provider });
            }
        }
        catch (IOException e) {
            ProviderUtil.LOGGER.error("Unable to open {}", new Object[] { url, e });
        }
    }
    ...
    static {
        ...
        COMPATIBLE_API_VERSIONS = new String[] { "2.0.0", "2.1.0" };
