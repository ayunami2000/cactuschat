...
public class Column
{
    ...
    public Column(final int x, final int z, final Chunk[] chunks, final CompoundTag[] tileEntities) {
        this(x, z, chunks, null, tileEntities);
    }
    
    public Column(final int x, final int z, final Chunk[] chunks, final byte[] biomeData, final CompoundTag[] tileEntities) {
        if (chunks.length != 16) {
