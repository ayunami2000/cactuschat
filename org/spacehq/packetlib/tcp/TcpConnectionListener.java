...
public class TcpConnectionListener implements ConnectionListener
{
    ...
    public void bind(final boolean wait, final Runnable callback) {
        ...
        final ChannelFuture future = ((AbstractBootstrap<ServerBootstrap, C>)((AbstractBootstrap<ServerBootstrap, Channel>)new ServerBootstrap()).channel(NioServerSocketChannel.class).childHandler(new ChannelInitializer<Channel>() {
