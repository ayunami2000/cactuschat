...
public class TcpClientSession extends TcpSession
{
    ...
    public void connect(final boolean wait) {
        ...
        try {
            ...
            ((AbstractBootstrap<AbstractBootstrap, Channel>)((AbstractBootstrap<Bootstrap, C>)((AbstractBootstrap<Bootstrap, C>)bootstrap).handler(new ChannelInitializer<Channel>() {
