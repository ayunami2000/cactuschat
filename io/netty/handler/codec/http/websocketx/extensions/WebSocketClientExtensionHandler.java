...
public class WebSocketClientExtensionHandler extends ChannelHandlerAdapter
{
    ...
    public void write(final ChannelHandlerContext ctx, final Object msg, final ChannelPromise promise) throws Exception {
        if (msg instanceof HttpRequest && WebSocketExtensionUtil.isWebsocketUpgrade((HttpMessage)msg)) {
            final HttpRequest request = (HttpRequest)msg;
            String headerValue = ((ConvertibleHeaders<AsciiString, String>)request.headers()).getAndConvert(HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS);
            ...
            request.headers().set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS, (CharSequence)headerValue);
        }
    ...
    public void channelRead(final ChannelHandlerContext ctx, final Object msg) throws Exception {
        if (msg instanceof HttpResponse) {
            ...
            if (WebSocketExtensionUtil.isWebsocketUpgrade(response)) {
                final String extensionsHeader = ((ConvertibleHeaders<AsciiString, String>)response.headers()).getAndConvert(HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS);
