...
public class WebSocketServerExtensionHandler extends ChannelHandlerAdapter
{
    ...
    public void channelRead(final ChannelHandlerContext ctx, final Object msg) throws Exception {
        if (msg instanceof HttpRequest) {
            ...
            if (WebSocketExtensionUtil.isWebsocketUpgrade(request)) {
                final String extensionsHeader = ((ConvertibleHeaders<AsciiString, String>)request.headers()).getAndConvert(HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS);
    ...
    public void write(final ChannelHandlerContext ctx, final Object msg, final ChannelPromise promise) throws Exception {
        if (msg instanceof HttpResponse && WebSocketExtensionUtil.isWebsocketUpgrade((HttpMessage)msg) && this.validExtensions != null) {
            final HttpResponse response = (HttpResponse)msg;
            String headerValue = ((ConvertibleHeaders<AsciiString, String>)response.headers()).getAndConvert(HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS);
            ...
            if (headerValue != null) {
                response.headers().set((CharSequence)HttpHeaderNames.SEC_WEBSOCKET_EXTENSIONS, (CharSequence)headerValue);
            }
        }
