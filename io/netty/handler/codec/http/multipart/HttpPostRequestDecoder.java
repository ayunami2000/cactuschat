...
public class HttpPostRequestDecoder implements InterfaceHttpPostRequestDecoder
{
    ...
    public static boolean isMultipart(final HttpRequest request) {
        return ((Headers<AsciiString>)request.headers()).contains(HttpHeaderNames.CONTENT_TYPE) && getMultipartDataBoundary(((ConvertibleHeaders<AsciiString, String>)request.headers()).getAndConvert(HttpHeaderNames.CONTENT_TYPE)) != null;
    }
