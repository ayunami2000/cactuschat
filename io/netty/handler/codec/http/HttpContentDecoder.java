...
public abstract class HttpContentDecoder extends MessageToMessageDecoder<HttpObject>
{
    ...
    protected void decode(final ChannelHandlerContext ctx, final HttpObject msg, final List<Object> out) throws Exception {
        ...
        if (msg instanceof HttpMessage) {
            ...
            String contentEncoding = ((ConvertibleHeaders<AsciiString, String>)headers).getAndConvert(HttpHeaderNames.CONTENT_ENCODING);
            ...
            ((Headers<AsciiString>)headers).remove(HttpHeaderNames.CONTENT_LENGTH);
            ...
            if (HttpHeaderValues.IDENTITY.equals(targetContentEncoding)) {
                ((Headers<AsciiString>)headers).remove(HttpHeaderNames.CONTENT_ENCODING);
            }
            else {
            ...
            if (message instanceof HttpContent) {
                ...
                copy.headers().set((TextHeaders)message.headers());
    ...
    protected CharSequence getTargetContentEncoding(final String contentEncoding) throws Exception {
