...
public class DefaultHttp2Headers extends DefaultBinaryHeaders implements Http2Headers
{
    ...
    public DefaultHttp2Headers(final boolean forceKeyToLower) {
    ...
    @Override
    public Http2Headers method(final AsciiString value) {
        this.set(PseudoHeaderName.METHOD.value(), value);
        return this;
    }
    
    @Override
    public Http2Headers scheme(final AsciiString value) {
        this.set(PseudoHeaderName.SCHEME.value(), value);
        return this;
    }
    
    @Override
    public Http2Headers authority(final AsciiString value) {
        this.set(PseudoHeaderName.AUTHORITY.value(), value);
        return this;
    }
    
    @Override
    public Http2Headers path(final AsciiString value) {
        this.set(PseudoHeaderName.PATH.value(), value);
        return this;
    }
    
    @Override
    public Http2Headers status(final AsciiString value) {
