...
public class DefaultBinaryMemcacheRequest extends AbstractBinaryMemcacheMessage implements BinaryMemcacheRequest
{
    ...
    public DefaultBinaryMemcacheRequest(final String key) {
        this(key, null);
    }
    
    public DefaultBinaryMemcacheRequest(final ByteBuf extras) {
        this(null, extras);
    }
    
    public DefaultBinaryMemcacheRequest(final String key, final ByteBuf extras) {
        super(key, extras);
