...
public class DefaultBinaryMemcacheResponse extends AbstractBinaryMemcacheMessage implements BinaryMemcacheResponse
{
    ...
    public DefaultBinaryMemcacheResponse(final String key) {
        this(key, null);
    }
    
    public DefaultBinaryMemcacheResponse(final ByteBuf extras) {
        this(null, extras);
    }
    
    public DefaultBinaryMemcacheResponse(final String key, final ByteBuf extras) {
        super(key, extras);
