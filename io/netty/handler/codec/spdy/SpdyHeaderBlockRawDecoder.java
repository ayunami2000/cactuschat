        ...
        while (headerBlock.isReadable()) {
            switch (this.state) {
                ...
                case READ_NAME: {
                    ...
                    if (((Headers<String>)frame.headers()).contains(this.name)) {
                        this.state = State.ERROR;
                        frame.setInvalid();
                        continue;
                    }
                ...
                case READ_VALUE_LENGTH: {
                    ...
                    if (this.length == 0) {
                        if (!frame.isTruncated()) {
                            frame.headers().add((CharSequence)this.name, (CharSequence)"");
                        }
                        this.name = null;
                        if (--this.numHeaders == 0) {
                            this.state = State.END_HEADER_BLOCK;
                ...
                case READ_VALUE: {
                    ...
                    while (index < this.length) {
                        ...
                        try {
                            frame.headers().add((CharSequence)this.name, (CharSequence)value);
                        }
