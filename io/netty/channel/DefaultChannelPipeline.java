...
final class DefaultChannelPipeline implements ChannelPipeline
{
    ...
    @Override
    public ChannelPipeline addFirst(final EventExecutorGroup group, String name, final ChannelHandler handler) {
        synchronized (this) {
    ...
    @Override
    public ChannelPipeline addFirst(final ChannelHandlerInvoker invoker, String name, final ChannelHandler handler) {
        synchronized (this) {
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addLast(final EventExecutorGroup group, String name, final ChannelHandler handler) {
        synchronized (this) {
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addLast(final ChannelHandlerInvoker invoker, String name, final ChannelHandler handler) {
        synchronized (this) {
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addBefore(final EventExecutorGroup group, final String baseName, String name, final ChannelHandler handler) {
        synchronized (this) {
    ...
    @Override
    public ChannelPipeline addBefore(final ChannelHandlerInvoker invoker, final String baseName, String name, final ChannelHandler handler) {
        synchronized (this) {
            final AbstractChannelHandlerContext ctx = this.getContextOrDie(baseName);
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addAfter(final EventExecutorGroup group, final String baseName, String name, final ChannelHandler handler) {
        synchronized (this) {
            final AbstractChannelHandlerContext ctx = this.getContextOrDie(baseName);
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addAfter(final ChannelHandlerInvoker invoker, final String baseName, String name, final ChannelHandler handler) {
        synchronized (this) {
            final AbstractChannelHandlerContext ctx = this.getContextOrDie(baseName);
            name = this.filterName(name, handler);
    ...
    @Override
    public ChannelPipeline addFirst(final ChannelHandlerInvoker invoker, final ChannelHandler... handlers) {
        if (handlers == null) {
            throw new NullPointerException("handlers");
        }
        if (handlers.length == 0 || handlers[0] == null) {
    ...
    @Override
    public ChannelPipeline addLast(final ChannelHandlerInvoker invoker, final ChannelHandler... handlers) {
        if (handlers == null) {
            throw new NullPointerException("handlers");
        }
        for (final ChannelHandler h : handlers) {
            ...
            this.addLast(invoker, null, h);
        }
        return this;
    }
    
    private ChannelHandlerInvoker findInvoker(final EventExecutorGroup group) {
        if (group == null) {
            return null;
        }
        Map<EventExecutorGroup, ChannelHandlerInvoker> childInvokers = this.childInvokers;
        if (childInvokers == null) {
            final IdentityHashMap<EventExecutorGroup, ChannelHandlerInvoker> childInvokers2 = new IdentityHashMap<EventExecutorGroup, ChannelHandlerInvoker>(4);
            this.childInvokers = childInvokers2;
            childInvokers = childInvokers2;
        }
    ...
    String generateName(final ChannelHandler handler) {
    ...
    private void destroyUp(AbstractChannelHandlerContext ctx) {
        ...
        for (tail = this.tail; ctx != tail; ctx = ctx.next) {
    ...
    private void destroyDown(final Thread currentThread, AbstractChannelHandlerContext ctx) {
    ...
    {
        private static final int SKIP_FLAGS;
        private static final String TAIL_NAME;
        
        TailContext(final DefaultChannelPipeline pipeline) {
            super(pipeline, null, TailContext.TAIL_NAME, TailContext.SKIP_FLAGS);
        }
        ...
        static {
            SKIP_FLAGS = AbstractChannelHandlerContext.skipFlags0(TailContext.class);
    ...
    static final class HeadContext extends AbstractChannelHandlerContext implements ChannelHandler
    {
        ...
        HeadContext(final DefaultChannelPipeline pipeline) {
            super(pipeline, null, HeadContext.HEAD_NAME, HeadContext.SKIP_FLAGS);
        ...
        static {
            SKIP_FLAGS = AbstractChannelHandlerContext.skipFlags0(HeadContext.class);
