...
public interface ChannelPipeline extends Iterable<Map.Entry<String, ChannelHandler>>
{
    ...
    ChannelPipeline addFirst(final ChannelHandlerInvoker p0, final String p1, final ChannelHandler p2);
    ...
    ChannelPipeline addLast(final ChannelHandlerInvoker p0, final String p1, final ChannelHandler p2);
    ...
    ChannelPipeline addBefore(final ChannelHandlerInvoker p0, final String p1, final String p2, final ChannelHandler p3);
    ...
    ChannelPipeline addAfter(final ChannelHandlerInvoker p0, final String p1, final String p2, final ChannelHandler p3);
    ...
    ChannelPipeline addFirst(final ChannelHandlerInvoker p0, final ChannelHandler... p1);
    ...
    ChannelPipeline addLast(final ChannelHandlerInvoker p0, final ChannelHandler... p1);
