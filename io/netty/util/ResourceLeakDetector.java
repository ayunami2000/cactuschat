...
public final class ResourceLeakDetector<T>
{
    ...
    private void reportLeak(final Level level) {
        ...
        while (true) {
            ...
            if (records.isEmpty()) {
                ...
                ResourceLeakDetector.logger.error("LEAK: {}.release() was not called before it's garbage-collected. See http://netty.io/wiki/reference-counted-objects.html for more information.{}", this.resourceType, records);
            }
        }
    }
    ...
    static {
        ...
        final String levelStr = SystemPropertyUtil.get("io.netty.leakDetectionLevel", ResourceLeakDetector.DEFAULT_LEVEL.name()).trim().toUpperCase();
    ...
    private final class DefaultResourceLeak extends PhantomReference<Object> implements ResourceLeak
    {
        ...
        public String toString() {
            ...
            final StringBuilder buf = new StringBuilder(16384).append(StringUtil.NEWLINE).append("Recent access records: ").append(array.length).append(StringUtil.NEWLINE);
            if (array.length > 0) {
