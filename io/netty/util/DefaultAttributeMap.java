...
public class DefaultAttributeMap implements AttributeMap
{
    ...
    public <T> boolean hasAttr(final AttributeKey<T> key) {
        ...
        if (((DefaultAttribute<Object>)head).key == key && !((DefaultAttribute<Object>)head).removed) {
            return true;
        }
        synchronized (head) {
            for (DefaultAttribute<?> curr = ((DefaultAttribute<Object>)head).next; curr != null; curr = ((DefaultAttribute<Object>)curr).next) {
                if (!((DefaultAttribute<Object>)curr).removed && ((DefaultAttribute<Object>)curr).key == key) {
                    return true;
                }
            }
            return false;
